...
- For "pick up the red object": 
  1. Analyze scene to locate red object
  2. Generate trajectory: approach → grasp → lift → move
  3. Execute with coordinated gripper actions
  
- For "organize the workspace":
  1. Analyze spatial layout
  2. Plan efficient multi-object manipulation
  3. Execute sequential pick-and-place operations

- For complex tasks:
  1. Break down into trajectory waypoints
  2. Label each step for clarity
  3. Coordinate arm and gripper actions
